<%@ Page Title="" Language="C#" MasterPageFile="~/Passenger/passenger.Master" AutoEventWireup="true" CodeBehind="booking_page.aspx.cs" Inherits="OnlineAirwayTicketBooking.Passenger.booking_page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <h1 class="text-center my-5">Miracle Airway</h1>
        ...
        <div class="row g-3 my-2">
                 <div class="row">
                    ...
                    <div class="form-outline mb-3 col-lg-4 col-md-6">
                     ...
                     <div class="pt-1 mb-4 "> 
                         <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-success btn-lg btn-block mb-3" Width="250" ValidationGroup="paymentGroup" OnClick="btnSearch_Click" />
                         <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn btn-secondary btn-lg btn-block mb-3" Width="250" OnClick="btnClear_Click" />
                    </div>
            </div>
